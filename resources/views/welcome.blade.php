<!DOCTYPE html>
<!-- This is a Blade template file for a Laravel URL Shortener web application. It includes HTML markup along with Blade templating syntax for dynamic content. The file contains sections for displaying a header with navigation links, a form to shorten URLs, and a section to display the shortened URL with a copy button functionality. Additionally, it includes JavaScript for clipboard functionality using ClipboardJS library. -->
    ...
    <section class="result-section" id="shortened-url">
        ...
        <div class="flex items-center">
            <button id="copy-button" data-clipboard-target="#short-link"
                    class="bg-blue-300 outline-black text-gray-800 font-medium py-2 px-4 rounded-md ml-4 hover:bg-green-300 focus:outline-none focus:ring-2 focus:ring-gray-500">
                Copy
            </button>
        </div>
    </section>
